 ...
 */
public class MyEdificioDb extends AbstractPgObject {
	private int id;
	private int inmueble_id;
  private String tipo_inmueble_id;
	private String tipo_edificio_id;
  ...
  public String getTipo_edificio_id() {
    return tipo_edificio_id;
  }

  public void setTipo_edificio_id(String tipo_edificio_id) {
    this.tipo_edificio_id = tipo_edificio_id;
  }
