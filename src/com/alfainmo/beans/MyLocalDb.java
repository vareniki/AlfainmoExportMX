 ...
 */
public class MyLocalDb extends AbstractPgObject {
	private int id;
	private int inmueble_id;
  private String tipo_local_id;
  ...
  public String getTipo_local_id() {
    return tipo_local_id;
  }

  public void setTipo_local_id(String tipo_local_id) {
