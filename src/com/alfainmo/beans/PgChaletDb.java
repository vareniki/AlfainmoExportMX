 ...
 */
public class PgChaletDb extends AbstractPgObject {
	private int id;
	private int inmueble_id;
	private String tipo_chalet_id;
	...
	private double area_no_contruida;
  ...
  private String comunidad_moneda_id;
	...
	public String getTipo_chalet_id() {
		return tipo_chalet_id;
	}

	public void setTipo_chalet_id(String tipo_chalet_id) {
		this.tipo_chalet_id = tipo_chalet_id;
	}
	...
	public int getArea_parcela() {
		return area_parcela;
	}

	public void setArea_parcela(int area_parcela) {
	...
	public double getArea_no_contruida() {
		return area_no_contruida;
	}

	public void setArea_no_contruida(double area_no_contruida) {
		this.area_no_contruida = area_no_contruida;
	}
