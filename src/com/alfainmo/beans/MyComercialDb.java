 ...
 */
public class MyComercialDb extends AbstractPgObject {
	private int id;
	private int inmueble_id;
  private String tipo_inmueble_id;
	private String tipo_comercial_id;
  ...
  private String con_videollamada;
  ...
  public String getTipo_comercial_id() {
    return tipo_comercial_id;
  }

  public void setTipo_comercial_id(String tipo_comercial_id) {
    this.tipo_comercial_id = tipo_comercial_id;
  }
  ...
  public String getCon_videollamada() {
    return con_videollamada;
  }

  public void setCon_videollamada(String con_videollamada) {
    this.con_videollamada = con_videollamada;
  }
