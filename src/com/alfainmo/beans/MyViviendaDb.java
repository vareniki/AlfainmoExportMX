 ...
 * @author dmonje
 */
public class MyViviendaDb extends AbstractPgObject {
  private int id;
	private int inmueble_id;
  private String tipo_inmueble_id;
	private String tipo_vivienda_id;
  ...
  private int area_no_construida;
  ...
  public String getTipo_vivienda_id() {
    return tipo_vivienda_id;
  }

  public void setTipo_vivienda_id(String tipo_vivienda_id) {
  ...
  public int getArea_no_construida() {
    return area_no_construida;
  }

  public void setArea_no_construida(int area_no_construida) {
    this.area_no_construida = area_no_construida;
  }
